...
# #SBATCH --job-name=simple_single_lens_noARC # Job name
...
# # #~==============================================================================
# python_script_file_name=simple_single_lens_noARC
...
# # JSON file path
# json_file_path=/cfs/data/asab1238/MEEPSAT_WFH/Tutorials/taurus_3_lens_sims/sunrise_sims/taurus_f2f_meeting_2025/LMF/multi_freq/gaussianwaves/simple_single_lens_noARC/sim_files/simple_single_lens_noARC.json
...
# JSON file path
json_file_path=/home/aak/Phd_work/public_github_repo/MeepSAT/examples/simple_single_lens_noARC/sim_files/sim_files/simple_single_lens_noARC.json
