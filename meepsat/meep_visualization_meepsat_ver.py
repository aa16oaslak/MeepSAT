...
This file is a modified version of the original meep_visualization.py file.
It has been adapted to work with the MEEPSAT project and includes customizations
for visualization in the context of MEEPSAT simulations.
It is not intended to be a direct replacement for the original file.
"""
#================================================================
